                  ...
                  <div class="table-responsive table-invoice">
                    <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td>GET</td>
                        <td>
                          <a href=<?php if($_SESSION['username'] == null){ echo 'ig_profile.php?id=rzapr&apikey=test';}else{echo 'ig_profile.php?id=rzapr&apikey='.$_SESSION['apikey'];}?> target="_blank" class="btn btn-primary">Test</a>
                        </td>
                      </tr>
                      <tr>
                        <td>instagram profile</td>
