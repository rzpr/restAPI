            ...
            <div class="card card-primary">
              ...
              if (isset($_POST['login'])) {
                  ...
                  $Password=md5($_POST['Password']);
                   $sql_cek=mysqli_query($conn,"SELECT * FROM users WHERE username='".$Username."' AND password='".$Password."' AND aktif='1'") or die(mysqli_error($conn));
                   ...
                   if ($jml_data>0) {
                    ...
                    $_SESSION['id_users'];
                    $_SESSION['apikey']=$r_cek['apikey'];
                    $_SESSION['email']=$r_cek['email'];
                    $_SESSION['no_hp']=$r_cek['no_hp'];
                    $_SESSION['batas']=$r_cek['batas'];
                    $_SESSION['tokenapi']=$r_cek['tokenapi'];
                    $_SESSION['rapi']=$r_cek['rapi'];
